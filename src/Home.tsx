...
import { ArrowRight, Check, X, Linkedin, User, Clock, Shield, Eye, ArrowUpRight, Menu, X as CloseIcon, Star, ChevronLeft, ChevronRight, ArrowUp } from 'lucide-react';
...
const companyLogos = [
    { name: 'Google', src: '/Google_logo.png' },
    { name: 'Meta', src: '/Meta_logo.png' },
    { name: 'Amazon', src: '/Amazon_logo.png' },
    { name: 'Netflix', src: '/Netflix_logo.png' },
    { name: 'Airbnb', src: '/airbnb_logo.png' },
    { name: 'Uber', src: '/uber_logo.png' },
    { name: 'Microsoft', src: '/Microsoft_logo.png' },
    { name: 'Apple', src: '/Apple_logo.png' },
    { name: 'Adobe', src: '/Adobe_logo.png' },
    { name: 'Salesforce', src: '/salesforce_logo.png' },
    { name: 'Twitter', src: '/twitter_x_logo.png' }
];
        ...
        <div className="min-h-screen bg-white text-stripe-navy overflow-x-hidden font-sans selection:bg-brand-500/10 selection:text-brand-500">
                                    ...
                                    {[
                                        ...
                                        <div 
                                            ...
                                            onClick={() => {
                                                ...
                                                if (el) {
                                                    const offset = 400; // Land directly on the pricing card
                                                    window.scrollTo({
                                            ...
                                            className="flex items-center justify-between py-6 border-b border-brand-500/5 last:border-0 hover:bg-brand-500/5 transition-all -mx-6 px-6 rounded-2xl cursor-pointer group/item animate-in fade-in slide-in-from-bottom-2 duration-700" 
            ...
            <footer id="contact" className="py-24 px-4 sm:px-6 border-t border-brand-500/10 bg-white animate-in fade-in duration-1000">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="pt-8 border-t border-brand-500/5 flex flex-col md:flex-row justify-between items-center gap-6">
                        <div className="text-sm text-stripe-slate/50 font-bold tracking-[0.2em] uppercase">
                            © 2026 WhoPosted. All rights reserved.
                        </div>
                        <div className="text-xs text-stripe-slate/40 font-bold uppercase tracking-[0.2em] flex items-center gap-2">
                            <span>Powered by</span>
                            <div className="flex items-center gap-2">
                                <span className="text-brand-500/60 hover:text-brand-500 transition-colors cursor-default">Provenetix</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {showScrollTop && (
                <button
                    onClick={scrollToTop}
                    className="fixed bottom-8 right-8 z-[60] p-4 rounded-2xl bg-brand-500 text-white shadow-elevated hover:bg-brand-600 transition-all duration-300 hover:scale-110 active:scale-95 animate-in fade-in slide-in-from-bottom-4 group"
                >
